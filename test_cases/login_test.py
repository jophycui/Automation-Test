...
proctor_url,password,proctor_name,access_url,student_id,exam_token,full_name,grade=conf.login_info()
...
class ExamLogin(unittest.TestCase):
    ...
    def test_empty_values(self):
        ...
        driver.find_element_by_id("validationToken").clear()
        driver.find_element_by_id("validationToken").send_keys("")       
    ...
    def test_invalid_values(self):
        ...
        driver.find_element_by_id("validationToken").clear()
        driver.find_element_by_id("validationToken").send_keys("heise")       
        driver.find_element_by_css_selector("input.btn").click()
